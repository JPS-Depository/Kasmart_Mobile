...
public class WajibEditFragment extends Fragment {
    int id, radioId;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        displayTanggal = (TextView) view.findViewById(R.id.tanggal_wajib);
        displayLokasi = (TextView) view.findViewById(R.id.isi_lokasi_wajib);

        statusGroup = (RadioGroup) view.findViewById(R.id.status_radio_wajib);
        ...
        edit = (Button) view.findViewById(R.id.button_input_edit_wajib);
    ...
    private void insertItem(int id, String storedSasaran, String storedDetil, int radioId){
        String url = "http://192.168.100.12/kasmart_mobile/edit_wajib.php";
